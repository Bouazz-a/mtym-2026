...
// history replace, like the admin pages).
                    ...
                    <Fragment key={i}>
                      ...
                      <div className="flex" style={{ borderTop: i > 0 ? "1px solid var(--border)" : undefined }}>
                        <div
                          ...
                          style={{ width: 84, background: "var(--paper-2)", borderRight: "2px solid var(--forest)" }}
                        >
...
function PauseBand({ minutes }: { minutes: number }) {
  return (
    <div
      ...
      style={{
        height: 24 + Math.min(minutes, 90) * 0.4,
  ...
  return (
    <div className="flex items-center gap-4 flex-wrap">
      ...
      <div className="flex items-center gap-2 ml-auto flex-wrap">
        ...
        <Link to={`/passages/${passage.id}?onglet=rapport`}>
